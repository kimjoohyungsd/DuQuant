...
class DuQuantLlamaConfig(LlamaConfig):
    model_type = "llama_FlatQuant"


class DuQuantFP16LlamaAttention(LlamaFlashAttention2):
...
class DuQuantLlamaAttention(DuQuantFP16LlamaAttention):
...
class DuQuantLlamaMLP(LlamaMLP):
    def __init__(self, options, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.options = options
        self.quantizer = deploy.nn.Quantizer()
